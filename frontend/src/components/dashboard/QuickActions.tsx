import { Brain, ShieldCheck, BarChart3, Download, ArrowRight, Briefcase } from "lucide-react";

const actions = [
  { label: "Run Credit Prediction", icon: Brain, href: "/predict", primary: true },
  { label: "Run Enterprise Assessment", icon: Briefcase, href: "/enterprise" },
  { label: "Perform Fraud Check", icon: ShieldCheck, href: "/fraud" },
